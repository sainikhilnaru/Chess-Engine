...
public class BoardUtils {
    ...
    public  static final List<String> ALGEBRAIC_NOTATION = initilizeAlgebreicNotation();
    public  static final Map<String, Integer> POSITION_TO_COORDINATE =initilizePositionToCoordinateMap();

    //tile id that begins the row
    ...
    private static List<String> initilizeAlgebreicNotation() {
